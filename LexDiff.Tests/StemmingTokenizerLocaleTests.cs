...
public class StemmingTokenizerLocaleTests
{
    private sealed class CapturingStemmingTokenizer : StemmingTokenizer
    {
        ...
        public List<ITokenizer> Segmenters { get; } = new();
        ...
        protected override ITokenizer CreateSegmenter(CultureInfo culture)
        {
	...
	[Fact(Skip = "Disabled in VSTO: ICU4N word segmentation for Thai not available here.")]
